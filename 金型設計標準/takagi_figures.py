...
FIGS = [
    ...
    {'id': '順5-12', 'slide': 48, 'box': (0.00, 0.49, 1.00, 1.00),
     'thr': 200, 'hide': [],
     'hide_final': [(0.11, 0.87, 0.20, 0.96), (0.395, 0.895, 0.49, 0.97),
                    (0.80, 0.87, 0.90, 0.96)]},          # 〈図1〉〈図2〉〈図3〉
    ...
    {'id': '共C3-15', 'slide': 45, 'box': (0.575, 0.02, 1.00, 0.96), 'thr': 200,
     # 〈図1〉は赤字「オーバハングで支える」と同じ高さで重なり分離不可のため残す。
     'hide_final': [(0.52, 0.90, 0.66, 1.00)]},           # 〈図2〉（下段）のみ
    ...
    {'id': '順6-5', 'slide': 73, 'box': (0.00, 0.57, 1.00, 1.00), 'thr': 200,
     'hide_final': [(0.06, 0.905, 0.15, 0.985), (0.48, 0.905, 0.58, 0.985),
                    (0.80, 0.905, 0.90, 0.985),           # 〈図1〉〈図2〉〈図3〉
    ...
    {'id': '順6-7', 'slide': 78, 'box': (0.00, 0.28, 0.60, 0.97), 'thr': 200,
     'hide_final': [(0.51, 0.485, 0.73, 0.55),            # 見出し末尾の〈図1〉〈図2〉
                    (0.175, 0.905, 0.29, 0.985),          # 〈図1〉
                    (0.72, 0.44, 0.83, 0.505)]},          # 右上の見切れ断片
