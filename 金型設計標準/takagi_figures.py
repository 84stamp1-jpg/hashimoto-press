...
FIGS = [
    ...
    {'id': '順5-12', 'slide': 48, 'box': (0.00, 0.49, 1.00, 1.00),
     'thr': 200, 'hide': []},
    # 順送 2-1 金型各プレートの名称（スライド8 左の断面図。各プレート名＋鋼材の色分け）
    {'id': '順2-1', 'slide': 8, 'box': (0.00, 0.06, 0.685, 1.00), 'thr': 200},
    # 順送 2-7 送り線高さ・パスライン（スライド11 下段 図1・図2）
    {'id': '順2-7', 'slide': 11, 'box': (0.00, 0.40, 1.00, 0.97), 'thr': 200},
    # 順送 4-1 上型（スライド19 右の U溝・クランプ厚み表＋図1）
    # 当社はオートクランプが無いため、図下部の「オートクランプ」ラベルは白塗りで消す
    {'id': '順4-1', 'slide': 19, 'box': (0.52, 0.10, 1.00, 0.97), 'thr': 200,
     'hide': [(0.13, 0.88, 0.52, 0.96)]},
    # 順送 4-7 パンチプレート厚み（スライド30 図1＋計算式）
    {'id': '順4-7', 'slide': 30, 'box': (0.00, 0.28, 1.00, 0.93), 'thr': 200},
