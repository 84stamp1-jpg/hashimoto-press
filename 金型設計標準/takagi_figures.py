...
FIGS = [
    ...
    # 側面図（下段の断面）は不要（顧客指摘）。切り出し下端を上げて平面図だけ残す。
    # 平面図の下にはみ出す中心線（旧・側面図への連結線）も白塗りで除去する。
    {'id': '共C2-6', 'slide': 19, 'box': (0.52, 0.395, 1.00, 0.765), 'thr': 200,
     'hide_final': [(0.40, 0.91, 0.46, 1.00)]},
