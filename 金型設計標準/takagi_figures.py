...
FIGS = [
    ...
    # トン数別のU溝寸法表（≦200トン等）は不要（顧客指摘）のため、切り出し上端を
    # 下げて表・〈表1〉ごと除外し、U溝の図だけを残す。
    {'id': '共C2-6', 'slide': 19, 'box': (0.52, 0.395, 1.00, 0.97), 'thr': 200,
     'hide': [(0.13, 0.85, 0.52, 0.94)],                  # オートクランプ ラベル
     'hide_final': [(0.38, 0.90, 0.57, 1.00),             # 下部の〈図1〉
                    (0.16, 0.78, 0.60, 0.875)]},          # 側面図の宙ぶらりん引出線＋見切れ文字
    # 共通 C2-10 パンチホルダー ※旧・順送4-7（第3次移行）
    {'id': '共C2-10', 'slide': 30, 'box': (0.00, 0.28, 1.00, 0.93), 'thr': 200,
     'hide_final': [(0.26, 0.90, 0.345, 0.99),            # 〈図1〉
                    (0.555, 0.455, 0.62, 0.57)]},         # 注記頭の改訂△18
