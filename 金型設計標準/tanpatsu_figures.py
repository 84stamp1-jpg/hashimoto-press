...
FIGS = {
    ...
    # ・断面図の下半分が見切れていたため下端を拡張（顧客指摘）。左右の表罫線は範囲外に。
    '単3-3': dict(page=8, box=(0.07, 0.375, 0.955, 0.633), hide=[]),
